...
╩═╝╚╝╚═╝╩ ╩╚═╝╩╚═  ╝╚╝╚═╝╚═╝╚═╝╚═╝╚═╝    
      """)
print("==== By LEQUANGQUOCKHANH - VKM - V4 ====")
print("⏳ Generating Nessus key... Vui lòng đợi")
...
if __name__ == '__main__':
    try:
        ...
        print("Tạo key lỗi. Hãy kiểm tra lại kết nối mạng hoặc liên hệ với Khánh đẹp trai")
        time.sleep(120)